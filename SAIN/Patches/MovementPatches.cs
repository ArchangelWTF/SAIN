...
{
    private static readonly AccessTools.FieldRef<MovementContext, Player> _playerField = AccessTools.FieldRefAccess<
        MovementContext,
        Player
    >("_player");
    ...
    {
        if (_playerField(__instance.MovementContext) is Player player)
        {
