...
public class HearingSettings : SAINSettingsBase<HearingSettings>, ISAINSettings
{
    static HearingSettings()
    {
        ...
        HearingDistancesDefaults = new Dictionary<ECaliber, float>()
        {
            ...
            { ECaliber.Caliber1036x77, 250f },
            { ECaliber.Caliber11x33R, 150f },
            { ECaliber.Caliber25x59, 250f },
            { ECaliber.Caliber762x67B, 200f },
            { ECaliber.Caliber784x49, 200f },
            { ECaliber.Caliber792x57, 225f },
            { ECaliber.Caliber86x43, 200f },
            { ECaliber.Caliber86x63, 250f },
            { ECaliber.Caliber93x64, 240f },
