...
public class ShootSettings : SAINSettingsBase<ShootSettings>, ISAINSettings
{
    ...
    public Dictionary<ECaliber, float> AmmoCaliberShootability = new()
    {
        ...
        { ECaliber.Caliber1036x77, 1f },
        { ECaliber.Caliber11x33R, 0.7f },
        { ECaliber.Caliber25x59, 1f },
        { ECaliber.Caliber762x67B, 1f },
        { ECaliber.Caliber784x49, 0.725f },
        { ECaliber.Caliber792x57, 0.85f },
        { ECaliber.Caliber86x43, 0.75f },
        { ECaliber.Caliber86x63, 1f },
        { ECaliber.Caliber93x64, 0.95f },
    ...
    public Dictionary<ECaliber, float> AmmoCaliberFullAutoMaxDistances = new()
    {
        ...
        { ECaliber.Caliber1036x77, 30f },
        { ECaliber.Caliber11x33R, 65f },
        { ECaliber.Caliber25x59, 30f },
        { ECaliber.Caliber762x67B, 40f },
        { ECaliber.Caliber784x49, 45f },
        { ECaliber.Caliber792x57, 45f },
        { ECaliber.Caliber86x43, 45f },
        { ECaliber.Caliber86x63, 35f },
        { ECaliber.Caliber93x64, 35f },
